...
from main.views import add_product_ajax, delete_product, dropdown_user, get_product_json, preview_product, show_main, create_product, show_xml, show_json, show_xml_by_id, show_json_by_id 
...
urlpatterns = [
    ...
    path('preview_product/', preview_product, name='preview_product'),
